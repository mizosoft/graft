...
func (LogEntry_Type) EnumDescriptor() ([]byte, []int) {
	return file_graft_proto_rawDescGZIP(), []int{6, 0}
}
...
type SnapshotRequest struct {
	...
	Term          int64                  `protobuf:"varint,1,opt,name=term,proto3" json:"term,omitempty"`
	LeaderId      string                 `protobuf:"bytes,2,opt,name=leaderId,proto3" json:"leaderId,omitempty"`
	Metadata      *SnapshotMetadata      `protobuf:"bytes,3,opt,name=metadata,proto3" json:"metadata,omitempty"`
...
type SnapshotMetadata struct {
	...
	ConfigUpdate     *ConfigUpdate          `protobuf:"bytes,3,opt,name=configUpdate,proto3,oneof" json:"configUpdate,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
const file_graft_proto_rawDesc = "" +
	...
	"\x04term\x18\x01 \x01(\x03R\x04term\x12\x1a\n" +
	"\bleaderId\x18\x02 \x01(\tR\bleaderId\x123\n" +
	"\bmetadata\x18\x03 \x01(\v2\x17.graft.SnapshotMetadataR\bmetadata\x12\x16\n" +
	...
	"\x04term\x18\x01 \x01(\x03R\x04term\"\x9d\x01\n" +
	"\bLogEntry\x12\x12\n" +
	...
	"\fconfigUpdate\x18\x03 \x01(\v2\x13.graft.ConfigUpdateH\x00R\fconfigUpdate\x88\x01\x01B\x0f\n" +
	"\r_configUpdate\"6\n" +
	"\n" +
	"NodeConfig\x12\x0e\n" +
